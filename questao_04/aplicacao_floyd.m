...
figure, imshow(I_Floyd_1,[]), title('Imagem cameraman após algoritmo de Floyd-Steinberg Dithering');
%-----------------------------------------------------------------------------------------------------------------
...
figure, imshow(I_Floyd_2,[]), title('Imagem lena após algoritmo de Floyd-Steinberg Dithering');