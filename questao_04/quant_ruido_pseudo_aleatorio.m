...
figure, imshow(uint8(I_qn_1 .* 90)), title('Imagem cameraman em 2 bits/pixel aplicado algoritmo de quantização com ruído pseudo-aleatório');
%-----------------------------------------------------------------------------------------------------------------
...
figure, imshow(uint8(I_qn_2 .* 90)), title('Imagem lena em 2 bits/pixel aplicado algoritmo de quantização com ruído pseudo-aleatório');
